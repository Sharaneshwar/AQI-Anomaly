...
async def get_site_data(
    ...
    start: str = Query(..., description="Start date-time (YYYY-MM-DDTHH:MM)", examples=["2024-03-10T00:00"]),
    end: str = Query(..., description="End date-time (YYYY-MM-DDTHH:MM)", examples=["2024-03-15T23:59"])
):
    """
